...
"ПОМНИ: Telegram — не научный журнал. Пиши короче. Одна мысль — один абзац. Максимум 3-4 абзаца. После поста у читателя должен остаться ВЫВОД, который можно запомнить."

"КРИТИЧЕСКИ ВАЖНО: Telegram — не диссертация.
- Максимум 300-400 символов
- 3-4 коротких абзаца
- Одна мысль — один абзац
- После поста читатель должен запомнить ОДНУ главную мысль"
